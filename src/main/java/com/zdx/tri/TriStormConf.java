...
public class TriStormConf {
	private static final Logger logger = LoggerFactory.getLogger(TriStormConf.class);

	public HashMap<Object, Object> loadConfigFromFile(String confFilePath){
		String fileContent = FileIO.readFile(confFilePath);
		if (fileContent.isEmpty()){
			logger.error("Tri Consumer Config File Is Empty, Please check it. confFilePath=" +confFilePath );
		}
